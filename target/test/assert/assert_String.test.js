...
(function() {
  ...
  describe('Assert | String |', function() {
    ...
    it('assert_File_Contains', function() {
      '.'.temp_File('aaa123').assert_File_Contains('aaa').assert_File_Contains('123').assert_File_Contains('aaa123').assert_File_Deleted();
      '.'.assert_File_Contains.assert_Is(''.assert_File_Contents_Contains);
      return (function() {
        return './package.json'.assert_File_Contains('-----****----');
      }).assert_Throws(function(error) {
    ...
    it('assert_File_Contents', function() {
      ...
      return (function() {
        return './package.json'.assert_File_Contents('-----****----');
      }).assert_Throws(function(error) {
        return error.message.assert_Contains("to be '-----****----'");
      });
    });
    ...
    it('assert_That_File_Exists', function() {
      ...
      (function() {
        return '.gitignore'.assert_That_File_Exists();
      }).assert_Not_Throws();
      return (function() {
    ...
    it('assert_That_File_Not_Exists', function() {
      ...
      return (function() {
        return '.gitignore'.assert_That_File_Not_Exists();
      }).assert_Throws();
    });
    it('assert_That_Folder_Exists', function() {
      ...
      (function() {
        return '.git'.assert_That_Folder_Exists();
      }).assert_Not_Throws();
      (function() {
    ...
    return it('assert_That_Folder_Not_Exists', function() {
      ...
      return (function() {
        return '.git'.assert_That_Folder_Not_Exists();
      }).assert_Throws();
    });
  });
